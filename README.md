...
Практична частина дипломної роботи **«Створення паралельного корпусу для машинного перекладу на основі текстів відеоігор»** — Київський національний університет імені Тараса Шевченка, 2026.
